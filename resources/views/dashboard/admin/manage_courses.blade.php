<x-admin-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-16 py-8 bg-white m-4">
        @foreach ($courses as $course)
            {{-- @include('dashboard.admin.partials.edit-modal') --}}
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4 flex px-2">
                ...
                {{-- <div class="flex justify-center items-center ml-auto">
                    <button data-modal-target="edit-modal-{{ $course->nama_kursus }}"
                        data-modal-toggle="edit-modal-{{ $course->nama_kursus }}" type="button"
